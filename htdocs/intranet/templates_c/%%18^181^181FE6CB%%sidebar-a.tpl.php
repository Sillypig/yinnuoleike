<?php /* Smarty version 2.6.19, created on 2013-03-03 17:21:04
...
"></button>
	...
	<?php endif; ?>
		...
		<div class="content-right-in">
			<h2><a id="quickfindertoggle" class="win-up" href="javascript:blindtoggle('quickfinder');toggleClass('quickfindertoggle','win-up','win-down');"><?php echo $this->_config[0]['vars']['myprojects']; ?>
</a></h2>
			<div id = "quickfinder">
				<form>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['openProjects'][$this->_sections['drop']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, "...", true) : smarty_modifier_truncate($_tmp, 40, "...", true)); ?>
</option>
						<?php endfor; endif; ?>
					</select>
				</form>
