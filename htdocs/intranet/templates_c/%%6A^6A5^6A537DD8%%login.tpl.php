<?php /* Smarty version 2.6.19, created on 2013-03-03 17:21:09
...
unset($_smarty_tpl_vars);
 ?>
		...
		<div class="login">
			<div class="login-in">
				<div class="logo-name">
					<h1><a href = "http://collabtive.o-dyn.de/" title = "<?php echo $this->_tpl_vars['settings']['name']; ?>
 Open Source project management"><img src="./templates/standard/images/logo-a.png" alt="<?php echo $this->_tpl_vars['settings']['name']; ?>
"  /></a></h1>
