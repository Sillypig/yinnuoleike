...
<div class="content-spacer"></div>
			...
			<div id="block_import" class="block">
				<div class="block_in_wrapper">
					<form novalidate class="main" method="post" action="manageimport.php?action=basecamp" enctype="multipart/form-data" <?php echo 'onsubmit="return validateCompleteForm(this);"'; ?>
>
					<fieldset>
