...
CREATE TABLE `roles_assigned` (
  ...
  PRIMARY KEY  (`ID`)
    ...
    $ins = mysql_query("INSERT INTO settings (name,subtitle,locale,timezone,dateformat,template,mailnotify,mailfrom,mailmethod) VALUES ('Innolake','Intranet','$locale','$timezone','d.m.Y','standard',1,'info@innolake.com','mail')");
