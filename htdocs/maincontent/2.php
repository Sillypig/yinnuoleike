<div style="margin:50px;">
	<table style="width: 748px; height: 408px;">
		<tbody>
			<tr>
				<td colspan="2">
					...
					<p style="text-align: center;position:relative">
						...
						<span id="retina_computers1" class="retina"></span>
			...
			<!--<tr>
				<td>
					<div style="position:relative">
						...
						<span id="computers3"></span>
						<span id="retina_computers3" class="retina"></span>
					</div>
				</td>
		...
		<tbody>
			<tr>
				...
				<td style="text-align:right;">
					<img src="images/cart.jpg" width="400" alt="" /><br>
				</td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			<tr>
				...
				<td style="text-align: right;width:480px;">
					<img src="images/969481396954507.jpg" width="450" alt="" />
				</td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			<tr>
				<td style="text-align: left;width:480px;">
					<img src="images/372234801994637.jpg" width="450" alt="" />
				</td>
				<td style="width:258px;">
					<div class="col-3 poloroidcopy last">
